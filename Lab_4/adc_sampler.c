...
#define SPI_SS 27   // GPIO for slave select (BCM 8 aka GPIO 8 aka SPI_CE0).
...
int main(int argc, char *argv[])
{
    ...
    if (argc < 3) {  // No filename supplied, get default
        ...
        snprintf(hold_fname, 32, "./bin_files/out-%4d-%02d-%02d-%02d.%02d.%02d.bin",tm.tm_year+1900, tm.tm_mon, tm.tm_mday, tm.tm_hour, tm.tm_min, tm.tm_sec);
